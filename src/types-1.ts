...
export type SetExecutionStatus = 'completed' | 'failed' | 'skipped' | 'abandoned';
export type WorkoutCompletionStatus = 'completed' | 'partial' | 'abandoned' | 'rest' | 'retroactive';
...
export interface ExerciseLog {
  /** Canonical ID of the variation actually performed. */
  exerciseId: string;
  /** Canonical ID of the prescribed variation, when different from performed variation. */
...
// ─── EXECUTION INPUT ─────────────────────────────────────────────────────────
export interface RawExerciseExecution {
  exerciseId?: string;
  exerciseName: string;
  plannedExerciseId?: string;
